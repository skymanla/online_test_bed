...
?>
	...
	<section id="contents">
		...
		<div class="bt_wrap3">
			<button type="button" class="bt_2" onclick="booking_change('<?=$list['bseq']?>', 'A');">승인</button>
			<button type="button" class="bt_2" onclick="booking_change('<?=$list['bseq']?>', 'R');">거절</button>
			<button type="button" class="bt_2" onclick="booking_change('<?=$list['bseq']?>', 'D');">삭제</button>
